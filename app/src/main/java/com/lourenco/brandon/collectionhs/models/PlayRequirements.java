...
public class PlayRequirements implements Parcelable {
    ...
    /* TODO */
    public List<Pair<Enums.PlayReq, Integer>> getAllRequirements()
    {
        List<Pair<Enums.PlayReq, Integer>> reqs = new ArrayList<>();

        /* TODO Redo implementation to avoid hard coding. (Reflection?) */
        if (REQMINIONTARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINION_TARGET, REQMINIONTARGET));
        if (REQFRIENDLYTARGET != null)  reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_FRIENDLY_TARGET, REQFRIENDLYTARGET));
        if (REQENEMYTARGET != null)     reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENEMY_TARGET, REQENEMYTARGET));
        if (REQDAMAGEDTARGET != null)   reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_DAMAGED_TARGET, REQDAMAGEDTARGET));
        if (REQENCHANTEDTARGET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENCHANTED_TARGET, REQENCHANTEDTARGET));
        if (REQFROZENTARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_FROZEN_TARGET, REQFROZENTARGET));
        if (REQCHARGETARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CHARGE_TARGET, REQCHARGETARGET));
        if (REQTARGETMAXATTACK != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_MAX_ATTACK, REQTARGETMAXATTACK));
        if (REQNONSELFTARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NONSELF_TARGET, REQNONSELFTARGET));
        if (REQTARGETWITHRACE != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_WITH_RACE, REQTARGETWITHRACE));
        if (REQTARGETTOPLAY != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_TO_PLAY, REQTARGETTOPLAY));
        if (REQNUMMINIONSLOTS != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NUM_MINION_SLOTS, REQNUMMINIONSLOTS));
        if (REQWEAPONEQUIPPED != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_WEAPON_EQUIPPED, REQWEAPONEQUIPPED));
        if (REQENOUGHMANA != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENOUGH_MANA, REQENOUGHMANA));
        if (REQYOURTURN != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_YOUR_TURN, REQYOURTURN));
        if (REQNONSTEALTHENEMYTARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NONSTEALTH_ENEMY_TARGET, REQNONSTEALTHENEMYTARGET));
        if (REQHEROTARGET != null)    reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_HERO_TARGET, REQHEROTARGET));
        if (REQSECRETCAP != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_SECRET_CAP, REQSECRETCAP));
        if (REQMINIONCAPIFTARGETAVAILABLE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINION_CAP_IF_TARGET_AVAILABLE, REQMINIONCAPIFTARGETAVAILABLE));
        if (REQMINIONCAP != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINION_CAP, REQMINIONCAP));
        if (REQTARGETATTACKEDTHISTURN != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_ATTACKED_THIS_TURN, REQTARGETATTACKEDTHISTURN));
        if (REQTARGETIFAVAILABLE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_IF_AVAILABLE, REQTARGETIFAVAILABLE));
        if (REQMINIMUMENEMYMINIONS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINIMUM_ENEMY_MINIONS, REQMINIMUMENEMYMINIONS));
        if (REQTARGETFORCOMBO != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_FOR_COMBO, REQTARGETFORCOMBO));
        if (REQNOTEXHAUSTEDACTIVATE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NOT_EXHAUSTED_ACTIVATE, REQNOTEXHAUSTEDACTIVATE));
        if (REQUNIQUESECRET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_UNIQUE_SECRET, REQUNIQUESECRET));
        if (REQTARGETTAUNTER != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_TAUNTER, REQTARGETTAUNTER));
        if (REQCANBEATTACKED != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CAN_BE_ATTACKED, REQCANBEATTACKED));
        if (REQACTIONPWRISMASTERPWR != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ACTION_PWR_IS_MASTER_PWR, REQACTIONPWRISMASTERPWR));
        if (REQTARGETMAGNET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_MAGNET, REQTARGETMAGNET));
        if (REQATTACKGREATERTHAN0 != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ATTACK_GREATER_THAN_0, REQATTACKGREATERTHAN0));
        if (REQATTACKERNOTFROZEN != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ATTACKER_NOT_FROZEN, REQATTACKERNOTFROZEN));
        if (REQHEROORMINIONTARGET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_HERO_OR_MINION_TARGET, REQHEROORMINIONTARGET));
        if (REQCANBETARGETEDBYSPELLS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CAN_BE_TARGETED_BY_SPELLS, REQCANBETARGETEDBYSPELLS));
        if (REQSUBCARDISPLAYABLE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_SUBCARD_IS_PLAYABLE, REQSUBCARDISPLAYABLE));
        if (REQTARGETFORNOCOMBO != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_FOR_NO_COMBO, REQTARGETFORNOCOMBO));
        if (REQNOTMINIONJUSTPLAYED != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NOT_MINION_JUST_PLAYED, REQNOTMINIONJUSTPLAYED));
        if (REQNOTEXHAUSTEDHEROPOWER != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_NOT_EXHAUSTED_HERO_POWER, REQNOTEXHAUSTEDHEROPOWER));
        if (REQCANBETARGETEDBYOPPONENTS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CAN_BE_TARGETED_BY_OPPONENTS, REQCANBETARGETEDBYOPPONENTS));
        if (REQATTACKERCANATTACK != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ATTACKER_CAN_ATTACK, REQATTACKERCANATTACK));
        if (REQTARGETMINATTACK != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_MIN_ATTACK, REQTARGETMINATTACK));
        if (REQCANBETARGETEDBYHEROPOWERS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CAN_BE_TARGETED_BY_HERO_POWERS, REQCANBETARGETEDBYHEROPOWERS));
        if (REQENEMYTARGETNOTIMMUNE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENEMY_TARGET_NOT_IMMUNE, REQENEMYTARGETNOTIMMUNE));
        if (REQENTIREENTOURAGENOTINPLAY != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENTIRE_ENTOURAGE_NOT_IN_PLAY, REQENTIREENTOURAGENOTINPLAY));
        if (REQMINIMUMTOTALMINIONS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINIMUM_TOTAL_MINIONS, REQMINIMUMTOTALMINIONS));
        if (REQMUSTTARGETTAUNTER != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MUST_TARGET_TAUNTER, REQMUSTTARGETTAUNTER));
        if (REQUNDAMAGEDTARGET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_UNDAMAGED_TARGET, REQUNDAMAGEDTARGET));
        if (REQCANBETARGETEDBYBATTLECRIES != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_CAN_BE_TARGETED_BY_BATTLECRIES, REQCANBETARGETEDBYBATTLECRIES));
        if (REQSTEADYSHOT != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_STEADY_SHOT, REQSTEADYSHOT));
        if (REQMINIONORENEMYHERO != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_MINION_OR_ENEMY_HERO, REQMINIONORENEMYHERO));
        if (REQTARGETIFAVAILABLEANDDRAGONINHAND != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_IF_AVAILABLE_AND_DRAGON_IN_HAND, REQTARGETIFAVAILABLEANDDRAGONINHAND));
        if (REQLEGENDARYTARGET != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_LEGENDARY_TARGET, REQLEGENDARYTARGET));
        if (REQFRIENDLYMINIONDIEDTHISTURN != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_FRIENDLY_MINION_DIED_THIS_TURN, REQFRIENDLYMINIONDIEDTHISTURN));
        if (REQFRIENDLYMINIONDIEDTHISGAME != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_FRIENDLY_MINION_DIED_THIS_GAME, REQFRIENDLYMINIONDIEDTHISGAME));
        if (REQENEMYWEAPONEQUIPPED != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_ENEMY_WEAPON_EQUIPPED, REQENEMYWEAPONEQUIPPED));
        if (REQTARGETIFAVAILABLEANDMINIMUMFRIENDLYMINIONS != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_IF_AVAILABLE_AND_MINIMUM_FRIENDLY_MINIONS, REQTARGETIFAVAILABLEANDMINIMUMFRIENDLYMINIONS));
        if (REQTARGETWITHBATTLECRY != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_WITH_BATTLECRY, REQTARGETWITHBATTLECRY));
        if (REQTARGETWITHDEATHRATTLE != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_TARGET_WITH_DEATHRATTLE, REQTARGETWITHDEATHRATTLE));
        if (REQDRAGTOPLAY != null) reqs.add(new Pair<Enums.PlayReq, Integer>(Enums.PlayReq.REQ_DRAG_TO_PLAY, REQDRAGTOPLAY));
